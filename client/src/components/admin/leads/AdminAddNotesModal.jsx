...
export default function AdminAddNotesModal({
  show,
  lead,
  submitting,
  onSubmit,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl">
        <div className="bg-gradient-to-r from-purple-500 to-pink-600 text-white p-6 rounded-t-xl relative">
          <h2 className="text-2xl font-bold">Add Notes (Admin)</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Your notes will be saved with "Admin" tag, your name, and timestamp
            </p>
          </div>
